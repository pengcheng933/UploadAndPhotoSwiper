...
(function (root, factory) {
  ...
  const SuperGif = function (opts) {
    ...
    const doShowProgress = function (pos, length, draw) {
      if (draw && showProgressBar) {
        ...
        if (options.is_vp) {
          ...
          if (false) {
            if (!ctx_scaled) {
              var l = options.vp_l; var
                t = options.vp_t;
              var w = options.vp_w; var
                h = options.vp_h;
            } else {
              var l = options.vp_l / get_canvas_scale(); var
                t = options.vp_t / get_canvas_scale();
              var w = options.vp_w / get_canvas_scale(); var
    ...
    let canvas; let ctx; let toolbar; let
      tmpCanvas;
